...
//                    startAutoPlay();
    ...
    public Banner start() {
        ...
        Glide.with(context).load(imageUrls.get(1)).into(mImagebg);
...
//                stopAutoPlay();
    ...
    class BannerPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            container.addView(imageViews.get(position), lp);
    ...
    public static ViewGroup.LayoutParams setViewMargin(View view, int left, int right, int top, int bottom) {
        ...
        if (params instanceof ViewGroup.MarginLayoutParams) {
            ...
            //不存在时创建一个新的参数
            marginParams = new ViewGroup.MarginLayoutParams(ViewGroup.MarginLayoutParams.WRAP_CONTENT, ViewGroup.MarginLayoutParams.WRAP_CONTENT);
        }
